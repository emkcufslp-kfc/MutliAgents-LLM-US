...
class HedgeFundGraph:
    ...
    def _deterministic_bull_case(self, state: AgentState) -> str:
        ...
        return (
            f"Summary: {state['ticker']} passed the point-in-time screen and earned {scorecard.get('total_score', 'N/A')}/40 "
    ...
    def _deterministic_bear_case(self, state: AgentState) -> str:
        ...
        return (
            f"Summary: The setup is investable, but it is not risk-free.\n\n"
            f"Evidence:\n"
